package com.ssafy.sse.exception.handler;

import static com.ssafy.sse.support.utils.ApiResponseUtil.createErrorResponse;

import com.fasterxml.jackson.core.JsonParseException;
import com.fasterxml.jackson.core.JsonProcessingException;
import com.ssafy.sse.exception.CustomException;
...
import com.ssafy.sse.support.responses.ErrorResponse;
...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(LoginInfoNotExistException.class)
    protected ResponseEntity<?> handleLoginInfoNotExistException(CustomException ex) {
        log.error("LoginInfoNotExistException", ex);
        return createErrorResponse(ErrorCode.FORBIDDEN_ERROR, ex.getMessage());
    }
