...
### 혼자 학습
  ...
  - 실시간 수업이 종료되면, 학생에게 숙제가 부여됩니다.
    - 학생은 혼자 학습에서 받아쓰기, 읽기, 일기 생성, 생성된 일기 읽기를 할 수 있습니다.
  - 학생의 혼자 학습에서 사용자와 상호작용을 높히기 위해 음성 기반으로 문답을 제공합니다.
    ...
    - Kakao의 Karlo를 활용해, 학생이 생성한 일기를 그림으로 변환해서 그림 일기를 제공합니다.
